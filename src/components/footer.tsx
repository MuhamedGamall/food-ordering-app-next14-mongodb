...
export default function Footer() {
  return (
    <footer className=" mt-10 flex justify-center flex-col items-center bg-white border-t w-[90%] max-w-[80rem] mx-auto  p-5">
      <div className=" mb-3 mt-2 flex gap-2 items-center justify-center">
        ...
        <ul className="flex items-center gap-2 text-[27px] hover:[&>li]:text-slate-600 [&>li]:cursor-pointer">
          <li>
            <Link href={"lhttps://www.linkedin.com/in/muhamed-gamal-468339241"}>
              <FaLinkedin />
            </Link>
          </li>
          <li>
      ...
      <span className=" mt-2 mb-5 text-center text-[15px]">
        ...
        <span className="text-[#2d5d2a] font-bold whitespace-nowrap text-[13px]"> Food ordering</span>.
      </span>
    </footer>
  );
}
